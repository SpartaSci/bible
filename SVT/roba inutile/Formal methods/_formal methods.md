...
>**Formal methods** can be used to achieve higher level of assurance about security, and they can be used throughout all the [[SVT/roba inutile/security assessment/development processes|development processe]]. Two aspects will be presented: [[SVT/roba inutile/Formal methods/formal specification/formal specification|formal specification]] and [[SVT/roba inutile/Formal methods/formal verification/formal verification|formal verification]]. The first has to do with how we give a precise unambiguous description of a system or of its security properties, the latter is related to how we verify formally that this property is hold for a particular system.
